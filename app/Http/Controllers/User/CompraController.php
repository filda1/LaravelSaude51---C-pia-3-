...
class CompraController extends Controller
{
    ...
    {
        $posts = compra::all();
        return view('user.compra.show',compact('posts'));   
    }
    ...
    public function create()
    {
        //if (Auth::user()->can('posts.create')) {
          ...
          return view('user.compra.post',compact('categories'));
       // }

       return view('user.compra.post');
    ...
    public function edit($id)
    {
       ...
       // if (Auth::user()->can('posts.update')) {
            ...
            return view('user.compra.edit',compact('post','id'));
       // }
